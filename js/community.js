...
if(com_name.length%3==0){
    ...
    for(i=0;i<com_name.length;i++){
        ...
        <div class="card-body">
        <h5 class="card-title txt">`+res[i]["community_name"]+`</h5>
        <p class="card-text txt">`+res[i]["description"]+`</p>
      ...
      <div class="col-md">
        ...
        <img src="images/makers tribe/mtj.png" class="card-img-top" alt="...">
        <div class="card-body">
        <h5 class="card-title txt">`+res[i+1]["community_name"]+`</h5>
        <p class="card-text txt">`+res[i+1]["description"]+`</p>
        <button class="btn btn-success pull-right">< < Join > ></button>
      </div></div><br></div>
      <div class="col-md">
        <div class="card bg-dark" style="width: 18rem;">
        <img src="images/makers tribe/mtj.png" class="card-img-top" alt="...">
        <div class="card-body">
        <h5 class="card-title txt">`+res[i+2]["community_name"]+`</h5>
        <p class="card-text txt">`+res[i+2]["description"]+`</p>
        <button class="btn btn-success pull-right">< < Join > ></button>
      </div></div><br></div>
    </div>`
        i=i+3
...
function scrap(){
  ...
  xhr.onreadystatechange = function(){
      if(xhr.readyState==4 && xhr.status==200){
          ...
          console.log(res[0]["community_name"]);
          console.log(res[0]);
      }
  }
  xhr.send();
